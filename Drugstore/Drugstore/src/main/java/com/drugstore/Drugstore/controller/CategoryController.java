...
public class CategoryController {
	...
	public ResponseEntity<List<Category>> GetBySection (@PathVariable String section) {
		return ResponseEntity.ok(repository.findAllBySectionsContainingIgnoreCase(section));
	}
